            ...
            {configLoading ? (
              ...
              <div className="space-y-4">
                ...
                {configuration?.Facebook && (
                  <div className="flex items-start space-x-4">
                    <a 
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center flex-shrink-0 hover:bg-blue-700 transition-all duration-300 transform hover:scale-105"
                    >
                      <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                {configuration?.youtube && (
                  <div className="flex items-start space-x-4">
                    <a 
                      href={configuration.youtube}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-12 h-12 bg-red-600 rounded-full flex items-center justify-center flex-shrink-0 hover:bg-red-700 transition-all duration-300 transform hover:scale-105"
                    >
                      <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                {/* Zonaprop */}
                {configuration?.Zonaprop && (
                  <div className="flex items-start space-x-4">
                    <a 
                      href={configuration.Zonaprop}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-12 h-12 bg-orange-500 rounded-full flex items-center justify-center flex-shrink-0 hover:bg-orange-600 transition-all duration-300 transform hover:scale-105"
                    >
                      <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-800">Zonaprop</h3>
                      <a 
                        href={configuration.Zonaprop}
                        target="_blank"
                        rel="noopener noreferrer"
                ...
                {(!configuration?.contactos || configuration.contactos.filter(c => c.instagram).length === 0) && 
                 !configuration?.Facebook && 
                 !configuration?.youtube && 
                 !configuration?.Zonaprop && (
                  <p className="text-gray-600">No hay redes sociales configuradas</p>
                )}
              </div>
            )}
          </section>

          {/* Sección 3: Resto de contactos (Teléfono, Email, WhatsApp) */}
          <section className="bg-white rounded-lg shadow-md p-6">
            ...
            {configLoading ? (
              ...
              <div className="space-y-6">
                {configuration?.contactos && configuration.contactos.length > 0 ? (
                  configuration.contactos.map((contacto) => (
                    <div key={contacto.id} className="border-b border-gray-200 pb-6 last:border-b-0 last:pb-0">
                      {contacto.nombre && (
                        <h3 className="text-lg font-semibold text-gray-800 mb-4">{contacto.nombre}</h3>
                      )}
                      <div className="space-y-4">
                        {/* Teléfono */}
                        {contacto.telefono && (
                          <div className="flex items-start space-x-4">
                            ...
                            <div>
                              <h4 className="text-md font-semibold text-gray-800">Teléfono</h4>
                              <a 
                                href={`tel:${contacto.telefono.replace(/\D/g, '')}`}
                                className="text-blue-600 hover:text-blue-700 transition-colors"
                              >
                        ...
                        {contacto.whatsapp && (
                          <div className="flex items-start space-x-4">
                            ...
                            <div>
                              <h4 className="text-md font-semibold text-gray-800">WhatsApp</h4>
                              <a 
                                href={`https://wa.me/${contacto.whatsapp.replace(/\D/g, '')}`}
                                target="_blank"
                                rel="noopener noreferrer"
